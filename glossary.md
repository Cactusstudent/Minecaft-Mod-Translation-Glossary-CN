...
- Combat：战斗用品
- Brewing：酿造
- Saved Hotbars：已保存的快捷栏
- Survival Inventory：生存模式物品栏
- Colored Blocks：染色方块
- Natural Blocks：自然方块
- Functional Blocks：功能方块
- Redstone Blocks：红石方块
- Tools & Utilities：工具与实用物品
- Food & Drinks：食品与饮品
- Ingredients：原材料
- Spawn Eggs：刷怪蛋
- Operator Utilities：管理员用品
- Block：方块
- Item：物品
- Tools：工具
- Armor：盔甲
